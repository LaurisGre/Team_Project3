...
if (isset($_POST['submit'])) {
    ...
    if (($_POST['item_ID'] !== '') && ((int)$_POST['item_ID'] > 0) && ($_POST['item_size'] !== '')) {
        ...
        <section class="buy-box">
            ...
            <?php else : ?>
                <div class="catalog-product-card">
                    ...
                    <img class="catalog-product-img style-<?php print $_POST['item_size']; ?>" src="<?php print $bought_item['photo']; ?>" alt="photo">
                </div>
            <?php endif; ?>
        </section>
